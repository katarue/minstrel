                      ...
                      <div className="flex flex-col gap-2 w-full sm:w-auto">
                        ...
                        {ev.official_url && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-body rounded inline-flex items-center justify-center transition-colors cursor-pointer border border-gold text-bordeaux hover:bg-gold/10 px-5 py-2.5 text-sm w-full sm:min-w-[9rem]"
                          >
                            {t("officialSite")}
                          </a>
                        )}
