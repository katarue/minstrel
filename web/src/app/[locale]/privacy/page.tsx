...
export default async function PrivacyPage() {
  ...
  if (locale === "en") {
    return (
      <div className="max-w-2xl mx-auto px-4 md:px-8 py-12">
        <h1 className="font-heading text-ink-heading text-2xl md:text-3xl font-bold mb-8">Privacy Policy</h1>
        <div className="font-body text-ink-body text-base leading-relaxed flex flex-col gap-6">
          ...
          <p>
            Minstrel collects limited personal information (name, email address, and inquiry content submitted via contact form, and access logs) solely for responding to inquiries and improving the service.
          </p>
          <p>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 md:px-8 py-12">
      <h1 className="font-heading text-ink-heading text-2xl md:text-3xl font-bold mb-8">プライバシーポリシー</h1>
      <div className="font-body text-ink-body text-base leading-relaxed flex flex-col gap-6">
        <p>Minstrel（以下「本サービス」）は、ユーザーの個人情報の取り扱いについて、以下のとおりプライバシーポリシーを定めます。</p>
        ...
        <section className="flex flex-col gap-2">
          ...
          <p>本サービスでは、サービス改善のためにアクセス解析ツールを使用する場合があります。収集されるデータは匿名化されており、個人を特定するものではありません。</p>
        </section>
        <section className="flex flex-col gap-2">
          <h2 className="font-heading text-ink-heading text-lg font-semibold">5. 情報の管理</h2>
          <p>収集した個人情報は適切に管理し、紛失・漏洩・改ざん等の防止に努めます。利用目的に必要な期間を経過した情報は適切な方法で削除します。</p>
        </section>
        <section className="flex flex-col gap-2">
        ...
        <section className="flex flex-col gap-2">
          ...
          <p>本ポリシーは必要に応じて改定することがあります。改定後のポリシーはこのページに掲載します。</p>
        </section>
